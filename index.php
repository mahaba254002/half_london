...
<head>
  ...
  <!-- 
    - primary meta tags
  -->
  <title>Half London Restaurant</title>
  <meta name="title" content="Half London Restaurant">
...
<body id="top">
  ...
  <div class="topbar">
    <div class="container">
      ...
      <address class="topbar-item">
        ...
        <span class="span">
          Half London Restaurant,123 Jalan Foodie. 05000 Alor Setar Kedah, Malaysia
        </span>
      </address>
      ...
      <div class="topbar-item item-2">
        ...
        <span class="span">Daily : 6.00 am to 11.59 pm</span>
      </div>

      <a href="tel:+601114898619" class="topbar-item link">
        <div class="icon">
          <ion-icon name="call-outline" aria-hidden="true"></ion-icon>
        </div>

        <span class="span">+601 114 898 619</span>
      </a>

      <div class="separator"></div>

      <a href="mailto:halflondon@restaurant.com" class="topbar-item link">
        <div class="icon">
          <ion-icon name="mail-outline" aria-hidden="true"></ion-icon>
        </div>

        <span class="span">halflondon@restaurant.com</span>
      </a>
  ...
  <header class="header" data-header>
    <div class="container">
      ...
      <a href="#" class="logo">
        <img src="favicon.png" width="160" height="50" alt="Half London - Home">
      </a>
      ...
      <nav class="navbar" data-navbar>
        ...
        <ul class="navbar-list">
          ...
          <li class="navbar-item">
            <a href="login.php">
              <img src="assets/images/login.png" alt="Login" width="40" height="40">
              <div class="separator"></div>
        ...
        <div class="text-center">
          ...
          <address class="body-4">
            Half London Restaurant, <br>
            Alor Setar Kedah, Malaysia
          </address>

          <p class="body-4 navbar-text">Open: 9.30 am - 2.30pm</p>

          <a href="mailto:booking@halflondon.com" class="body-4 sidebar-link">booking@halflondon.com</a>

          <div class="separator"></div>

          <p class="contact-label">Booking Request</p>

          <a href="tel:+60998877665" class="body-1 contact-number hover-underline">
            +60-9988-77665
          </a>
        </div>
        ...
        <ul class="hero-slider" data-hero-slider>
          ...
          <li class="slider-item active" data-hero-slider-item>
            ...
            <p class="body-2 hero-text slider-reveal">
              Come with family & feel the joy of mouthwatering delicacies
            </p>
      ...
      <section class="section service bg-black-10 text-center" aria-label="service">
        <div class="container">
          ...
          <p class="section-text">
            Begin food explaoration at Half London restaurant, where passion meets precision in every dish. From
            delectable appetizers to exquisite main courses, savor a symphony of flavors. Our commitment to quality
            ensures a memorable dining experience, celebrating exceptional taste and hospitality. Elevate your moments
            with us, indulging in unparalleled gastronomic delight
          </p>
      ...
      <section class="section about text-center" aria-labelledby="about-label" id="about">
        <div class="container">
          ...
          <div class="about-content">
            ...
            <p class="section-text">
              Welcome to Half London Restaurant, a culinary icon in northern Malaysia with a legacy spanning five
              decades. As one of the region's oldest establishments, we have perfected the art of creating an
              unforgettable dining experience. Our diverse menu features a fusion of Asian and Western delicacies,
              meticulously crafted to satisfy every palate.

              At Half London, we pride ourselves on our unwavering commitment to customer satisfaction. Our restaurant
              has evolved into a gastronomic hub, drawing locals and tourists alike to indulge in the finest flavors.
              Whether you're a seasoned local or a first-time visitor exploring the northern part of the country, Half
              London is a culinary destination that demands a visit. Join us for a journey of taste and tradition, where
              every dish tells a story of our rich culinary heritage.
            </p>

            <div class="contact-label">Book Through Call</div>

            <a href="tel:+60554466778" class="body-1 contact-number hover-underline">+60 5544 66778</a>
      ...
      <section class="special-dish text-center" aria-labelledby="dish-label">
        ...
        <div class="special-dish-content bg-black-10">
          <div class="container">
            ...
            <p class="section-text">
              Savor the decadence of our Lobster Tortellini, a culinary masterpiece at Half London Restaurant.
              Delicately crafted pasta envelopes the richness of succulent lobster, promising a symphony of flavors.
              Join us for an unforgettable dining experience where luxury meets culinary artistry.
            </p>

            <div class="wrapper">
              <del class="del body-3"> RM 150.00</del>

              <span class="span body-1">RM 99.00</span>
            </div>
          ...
          <ul class="grid-list">
            ...
            <li>
              <div class="menu-card hover:card">
                ...
                <figure class="card-banner img-holder" style="--width: 100; --height: 100;">
                  <img src="./assets/images/menu-1.jpg" width="100" height="100" loading="lazy" alt="Nasi Goreng"
                    class="img-cover">
                </figure>
                ...
                <div>
                  ...
                  <div class="title-wrapper">
                    ...
                    <span class="span title-2">Rm 30.50</span>
                  </div>

                  <p class="card-text label-1">
                    Sliced cucumbers, tomatoes,jasmine rice,ayam and eggs
                  </p>
              ...
              <div class="menu-card hover:card">
                ...
                <div>
                  ...
                  <div class="title-wrapper">
                    ...
                    <span class="span title-2">Rm 40.00</span>
                  </div>
            ...
            <li>
              <div class="menu-card hover:card">
                ...
                <figure class="card-banner img-holder" style="--width: 100; --height: 100;">
                  <img src="./assets/images/menu-3.jpg" width="100" height="100" loading="lazy" alt="Char Kway Teow"
                    class="img-cover">
                </figure>
                ...
                <div>
                  ...
                  <div class="title-wrapper">
                    <h3 class="title-3">
                      <a href="#" class="card-title">Char Kway Teow</a>
                    </h3>

                    <span class="span title-2">Rm 27.00</span>
                  </div>

                  <p class="card-text label-1">
                    noodles,prawns,bean sprouts and Chinese sausage
                  </p>
              ...
              <div class="menu-card hover:card">
                ...
                <div>
                  ...
                  <div class="title-wrapper">
                    ...
                    <span class="span title-2">Rm 39.00</span>
                  </div>
              ...
              <div class="menu-card hover:card">
                ...
                <div>
                  ...
                  <div class="title-wrapper">
                    ...
                    <span class="span title-2">Rm 25.00</span>
                  </div>
              ...
              <div class="menu-card hover:card">
                ...
                <div>
                  ...
                  <div class="title-wrapper">
                    ...
                    <span class="span title-2">Rm 49.00</span>
                  </div>
      ...
      <section class="reservation" id="reservation">
        <div class="container">
          ...
          <div class="form reservation-form bg-black-10">
            ...
            <!-- <form name="form" action="reserve.php" method="POST" class="form-left"> -->

              <!-- <h2 class="headline-1 text-center">Online Reservation</h2> -->
<!-- 
              <p class="form-text text-center">
                Booking request <a href="tel:+60-111-4898-619" class="link">+60-111-4898-619</a>
                or fill out the order form
              </p> -->
              <!-- <div class="form-container sign-up-container"> -->
            <form name="form" action="reserve.php" onsubmit="return isvalid()" method="post" >
                ...
                font-size: 12px;
                font-weight: bold;
                text-transform: uppercase;" type="text" placeholder="name" name="name" />
                <input style="border: 
                1px solid #FF4B2B;
                background-color:aquamarine;
                color: #FFFFFF;
                font-size: 12px;
                font-weight: bold;
                text-transform: uppercase;" type="tel" placeholder="phone" name="phone"/>
                <input style="border: 
                1px solid #FF4B2B;
                background-color:aquamarine;
                color: #FFFFFF;
                font-size: 12px;
                font-weight: bold;
                text-transform: uppercase;" type="text" placeholder="person" name="person"/>
                <input style="border: 
                1px solid #FF4B2B;
                background-color:aquamarine;
                color: #FFFFFF;
                font-size: 12px;
                font-weight: bold;
                text-transform: uppercase;" type="date" placeholder="reservation_date" name="reservation_date"/>
                <input style="border: 
                1px solid #FF4B2B;
                background-color:aquamarine;
                color: #FFFFFF;
                font-size: 12px;
                font-weight: bold;
                text-transform: uppercase;" type="time" placeholder="reservation_time" name="reservation_time"/>
                <input style="border: 
                1px solid #FF4B2B;
                background-color:aquamarine;
                color: #FFFFFF;
                font-size: 12px;
                font-weight: bold;
                text-transform: uppercase;" type="text" placeholder="message" name="message"/>
                <br><br>
...
<!-- 
            ...
            <div class="form-right text-center" style="background-image: url('./assets/images/form-pattern.png')">
              ...
              <a href="tel:+88123123456" class="body-1 contact-number hover-underline">+60-111-4898-619</a>
          ...
          <a href="#reservation-form" class="reservation-img">
            <img src="./assets/images/hero-icon.png" width="48" height="48" alt="booking icon">
          </a>
        </div>
      </section>
    ...
    <div class="container">
      ...
      <div class="footer-top grid-list">
        ...
        <div class="footer-brand has-before has-after">
          ...
          <a href="#" class="logo">
            <img src="favicon.png" width="280" height="70" loading="lazy" alt="half_london home">
          </a>
          ...
          <a href="mailto:booking@halflondon.com" class="body-4 contact-link">booking@halflondon.com</a>

          <a href="tel:+601114898619" class="body-4 contact-link">Booking Request : +60-111-4898-619</a>
      ...
      <div class="footer-bottom">
        ...
        <p class="copyright">
          &copy; 2022 Half London. All Rights Reserved | Crafted by  mahaba
        </p>
